# patch_manual_result.py
import shutil, os, py_compile

# Backup
if not os.path.exists("app_v2_backup.py"):
    shutil.copy("app.py", "app_v2_backup.py")
    print("✅ Backup: app_v2_backup.py")

NEW_APP = '''# app.py — v3 with manual results + close prediction flow
